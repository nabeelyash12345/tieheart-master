<?php session_start();
//if($_SESSION['djblogin']!='mydjbappdelhi'){header("location:login.php?signup=success");}
...
$response = array(); 
    ...
    if(isset($_REQUEST['title']) and isset($_REQUEST['message']) ){
    	...
    	$firebaseSuccess = $firebase->sendToTopic('global', $_REQUEST['title'],$_REQUEST['message'], $mPushNotification);
    }else{
    	$response['error']=true;
...
<html>
	...
	<body>
		<div class="maincontainer">
			...
			<form action="Send.php" onSubmit="return checkTextLen()">
				<input type="text" name="title" class="message" id="title" placeholder="Title" /><br />
				<textarea rows="5" name="message" class="message" id="message" cols="45" placeholder="Message"></textarea><br /><br/>
